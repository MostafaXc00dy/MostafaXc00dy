...
if not game.GameId == 3158442565 then
	print("Correct Game")
	script.Parent.Info.Visible = true
	game:GetService("StarterGui"):SetCore("SendNotification",{
		Title    = "Notification",
		Text     = "Outlaws is Here",
		Button1  = "Close",
		Duration = 15,
	})
else
	...
	btns:Button("Low silent aim", function()
	DiscordLib:Notification("Notification", "Low Knife and Gun silent aim Active", "Okay!")
	...
	btns:Button("No Knife cooldown", function()
		DiscordLib:Notification("Notification", "No Knife cooldown Active", "Okay!")
		local cons = {
			[10] = 0,
			[30] = 0.010
		}
	...
	local ESP = loadstring(game:HttpGet("https://raw.githubusercontent.com/MostafaXc00dy/MostafaXc00dy/main/EspC"))()
	ESP:Toggle(true)
	...
	btns:Button("Malek Server For Roblox", function()
		DiscordLib:Notification("Notification", "OWTLUAS SERVER LINK HAVE BEEN COPYED TO YOUR CLIPBOARD", "Okay")
		setclipboard("https://discord.gg/fgqFcnRY")
		toclipboard("https://discord.gg/fgqFcnRY")
	end)
	
	local lbls = serv:Channel("By divinity.#6431")
...
Notify("c00dy", "Outlaws is Here", "", 4);

local ohString1 = "Dont forget to subscribe to cOOdy"
local ohString2 = "All"
